...
namespace NicoDobler.Week10
{
    ...
    public static class Zoo3Main
    {
        ...
        {
            var heu = new Food("Heu", "kg", 2.00);
            var wasser = new Food("Wasser", "L", 0.05);
            var fleisch = new Food("Fleisch", "kg", 8.00);
            var obst = new Food("Obst", "kg", 3.50);
            var gemuese = new Food("Gemüse", "kg", 2.80);
