...
namespace MarcelSimma.Week05.Streams
{
    ...
    public static class StreamsExample
    {
        ...
        public static void Start()
        {
            ...
            using (StreamWriter str = new StreamWriter("\\Users\\BAU26336\\OneDrive - Julius Blum GmbH\\Allgemeines\\Dokumente\\output.txt")) {
        ...
        public static void ReadFile()
        {
            ...
            using (StreamReader str = new StreamReader("\\Users\\BAU26336\\OneDrive - Julius Blum GmbH\\Allgemeines\\Dokumente\\input.txt"))
            {
