...
CREATE TABLE IF NOT EXISTS ZooKeeper (Keeper_ID INT, Keeper_Firs_Name VARCHAR (20), Keeper_Last_Name VARCHAR (20), PRIMARY KEY (Keeper_ID));
CREATE TABLE IF NOT EXISTS Animal (Animal_ID INT, Animal_Species VARCHAR (30), Animal_Name VARCHAR (30), PRIMARY KEY (Animal_ID)); 
CREATE TABLE IF NOT EXISTS Animal_Food(Animal_Food_ID INT, Food_Name VARCHAR (30), Food_Price DOUBLE (10,2), Unit VARCHAR (10), PRIMARY KEY (Food_ID));
